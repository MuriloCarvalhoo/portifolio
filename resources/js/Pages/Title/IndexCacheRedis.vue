        ...
        <div class="col-12">
            <div v-if="loading" class="mb-5">
                ...
                <div class="progress mt-5">
                    <div class="progress-bar progress-bar-striped progress-bar-animated bg-primary" role="progressbar" aria-valuenow="75" aria-valuemin="0" aria-valuemax="100" style="width: 50%"></div>
                </div>
            </div>
            ...
            <div class="card"  v-show="!loading">
                ...
                <div class="card-body pb-2">
                    <div class="row mb-5">
                        <div class="col-md-4 col-sm-4 col-lg-4 col-xl-4">
                            <div class="input-group mb-2">
                                ...
                                <input
                                    type="text"
                                    class="form-control"
                                    placeholder="Search from TConst..."
                                    v-model="tconst"
                                >
                            </div>
                        </div>
                        <div class="col-md-4 col-sm-4 col-lg-4 col-xl-4">
                            <div class="input-group mb-2">
                                ...
                                <input
                                    type="text"
                                    class="form-control"
                                    placeholder="Search from Primary..."
                                    v-model="primary"
                                >
                            </div>
                        </div>
                        <div class="col-md-4 col-sm-4 col-lg-4 col-xl-4">
                            <div class="input-group mb-2">
                                ...
                                <input
                                    type="text"
                                    class="form-control"
                                    placeholder="Search from Original..."
                                    v-model="original"
                                >
                            </div>
                        </div>
                        ...
                        <div class="col-md-4 col-sm-4 col-lg-4 col-xl-4">
                            <div class="input-group mb-2">
                                <button type="button" class="btn btn-md btn-primary" @click="get()">BUSCAR</button>
                            </div>
                        </div>
                    </div>
                            ...
                            <tbody>
                                <tr v-for="(registro, index) in registros" :key="index">
                                    ...
                                    <td class="align-middle text-center">
                                        ...
                                        >
                                            <span
                                                v-for="(genre, index) in registro.genres"
                                                :key="index"
                                            >
                                                {{ genre.name }}
                                            </span>
